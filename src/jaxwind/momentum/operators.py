...
def _pcr_tridiagonal_solve(
    ...
    ``ceil(log2(n))`` vector stages and can fuse them with the surrounding
    IMEX kernel.  The IMEX matrix is strictly diagonally dominant, avoiding
    the pivoting requirements of a general tridiagonal solve.
    """
...
class MomentumOperators:
    ...
    def solve_vertical_sgs_diffusion(
        ...
        solution = _pcr_tridiagonal_solve(
