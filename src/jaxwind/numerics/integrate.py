...
from jaxwind.state import Boundaries, StaggeredVelocity, enforce_impermeability, zeros
from jaxwind.wall import MoninObukhovWall, sidewall_tendency, wall_tendency
...
class FlowModel:
    ...
    :class:`~jaxwind.sgs.AnisotropicMinimumDissipation` or
    :class:`~jaxwind.sgs.StaticSmagorinsky` instance to run a large-eddy
    simulation.
    """
