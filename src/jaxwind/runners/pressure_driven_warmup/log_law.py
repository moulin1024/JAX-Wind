"""Dependency-free neutral log-law diagnostic for pressure-driven cases."""
...
def write_log_law_svg(
    ...
    *,
    ...
    von_karman: float,
    model_label: str = "LASD",
    statistics_label: str = "configured sampling window",
) -> None:
    """Write a normalized velocity profile and its theoretical neutral law."""
    ...
    x_tick_values = [
        x_min + index * (x_max - x_min) / 5 for index in range(6)
    ]
    ...
    elements = [
        ...
        f'<title id="title">Pressure-driven {model_label} neutral log-law '
        "profile</title>",
